...
namespace YourVRExperience.Utils
{
	public class PlaneFromPoly : MonoBehaviour
	{
		...
		public void LogicCentered(Vector3 _posOrigin, Vector3 _posTarget)
		{
			LogicBase();

			gameObject.transform.position = new Vector3((_posOrigin.x + _posTarget.x) / 2, _posOrigin.y, (_posOrigin.z + _posTarget.z) / 2);
		}

		public void LogicBase()
		{
